...
var AudioBufferLoader = function (_Loader) {
  ...
  (0, _createClass3.default)(AudioBufferLoader, [{
    ...
    key: 'load',
    value: function load() {
      var fileURLs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : throwIfMissing();
    ...
    value: function loadOne(fileURL) {
      return (0, _get3.default)(AudioBufferLoader.prototype.__proto__ || (0, _getPrototypeOf2.default)(AudioBufferLoader.prototype), 'loadOne', this).call(this, fileURL).then(this.decodeAudioData.bind(this), function (error) {
        throw error;
      });
    }
...
myAudioBufferLoader.load('assets/test.wav').then(function (buffer) {
